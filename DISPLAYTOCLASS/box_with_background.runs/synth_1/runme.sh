...
HD_PWD='C:/Users/talmaw19/Desktop/0_box_with_background/box_with_background.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bouncing_box.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bouncing_box.tcl
