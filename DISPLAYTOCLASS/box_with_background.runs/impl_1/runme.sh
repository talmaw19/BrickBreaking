...
HD_PWD='C:/Users/talmaw19/Desktop/0_box_with_background/box_with_background.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bouncing_box.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bouncing_box.tcl -notrace
